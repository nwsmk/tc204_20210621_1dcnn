...
if __name__ == '__main__':
    ...
    f_train_path = "/data/users/c3471tl/tc204_20210621_1dcnn/dataset/tc204/train/"
    ...
    f_test_path = "/data/users/c3471tl/tc204_20210621_1dcnn/dataset/tc204/test/"
    ...
    # create model
    f_save_path = '/data/users/c3471tl/tc204_20210621_1dcnn/'
    for count in range(10):
        ...
        joblib.dump(cdf_x, f_save_path + "cdf_x_1dcnn" + "_c" + str(count) + ".save")
        joblib.dump(cdf_y, f_save_path + "cdf_y_1dcnn" + "_c" + str(count) + ".save")
